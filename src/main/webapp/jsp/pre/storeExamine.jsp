...
<!--End-breadcrumbs-->
	...
	<div class="layui-inline"> <!-- 注意：这一层元素并不是必须的 -->
	    ...
	    <div class="layui-input-block">
	      <input type="text" name="storeName" required  lay-verify="required" placeholder="请输入店铺名" autocomplete="off" class="layui-input">
	    </div>
	    <label class="layui-form-label">店主姓名</label>
	    <div class="layui-input-block">
	      <input type="text" name="ownerName" required  lay-verify="required" placeholder="请输入店主姓名" autocomplete="off" class="layui-input">
	    </div>
  		<button class="layui-btn layui-btn-radius layui-btn-normal" id="selectByName" data-type="reload">搜索</button>
	</div>
	...
	layui.use('table', function(){
		  ...
		  table.render({
		    ...
		    ,cols: [[ //表头
		      {field: 'storeName', title: '店铺名', sort: true, fixed: 'left'}
		      ,{field: 'ownerName', title: '店主姓名', sort: true}
		      ,{field: 'storeType', title: '店铺类型', sort: true}
		      ,{field: 'shzt', title: '审核状态', sort: true}
