          ...
          <div class="widget-content nopadding">
            <form id="form-wizard" class="form-horizontal" method="post">
              <div id="form-wizard-1" class="step">
                  ...
                  <div class="controls">
                    <input id="userName" type="text" name="userName" value="${leavedetail.userName}"/>
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">开始时间</label>
                  <div class="controls">
                    <input id="startTime" type="text" name="startTime" value="${leavedetail.startTime}"/>
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">结束时间</label>
                  <div class="controls">
                    <input id="endTime" type="text" name="endTime" value="${leavedetail.endTime}"/>
                  </div>
                </div>
